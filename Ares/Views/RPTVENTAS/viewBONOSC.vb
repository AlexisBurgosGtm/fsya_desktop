...
Public Class viewBONOSC
    Private Sub viewBONOSC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "GRID BONOS"
    ...
    Private Sub cargarGrid()
        ...
        Me.GridControlPRODUCTOS.DataSource = Nothing
            Me.GridControlPRODUCTOS.DataSource = objvpn.getTblBONOSVPN(GlobalParamDatePickI, GlobalParamDatePickF)
    ...
    Private Function tblTopProductos() As DataTable
        ...
        Using cn As New SqlConnection(Me.cmbSUCURSALES.SelectedValue.ToString)
            Try
                ...
                Dim cmd As New SqlCommand("SELECT           DOCUMENTOS.FECHA, DOCUMENTOS.CODDOC, DOCUMENTOS.CORRELATIVO, DOCPRODUCTOS.CODPROD, DOCPRODUCTOS.DESPROD, SUM(DOCPRODUCTOS.TOTALUNIDADES) AS UNIDADES, 
                                                            SUM(DOCPRODUCTOS.TOTALCOSTO) AS [T COSTO], SUM(DOCPRODUCTOS.TOTALPRECIO) AS [T PRECIO], PRODUCTOS.BONO, SUM(DOCPRODUCTOS.TOTALUNIDADES) * PRODUCTOS.BONO AS TOTALBONO, 
                                           ...
                                           GROUP BY         DOCPRODUCTOS.CODPROD, DOCPRODUCTOS.DESPROD, PRODUCTOS.BONO, EMPLEADOS.NOMEMPLEADO, DOCUMENTOS.FECHA, DOCUMENTOS.CODDOC, DOCUMENTOS.CORRELATIVO
