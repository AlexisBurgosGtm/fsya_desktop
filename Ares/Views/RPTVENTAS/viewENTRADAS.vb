...
Public Class viewENTRADAS
    ...
    Private Sub viewENTRADAS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cargarGrid()
        ...
        If FlyoutDialog.Show(Me.ParentForm, New viewFechaCAL) = DialogResult.OK Then
            ...
            Me.gridENTRADAS.DataSource = objvpn.getTblSalidasVpn(GlobalParamDatePickI, GlobalParamDatePickF)
    ...
    Private Sub btnExportarDataProductos_Click(sender As Object, e As EventArgs) Handles btnExportarDataProductos.Click
        ...
        Try
            Dim archivo As String = Application.StartupPath + "/EXPORTS/TRASLADOS" + Today.Month.ToString + ".xlsx"
