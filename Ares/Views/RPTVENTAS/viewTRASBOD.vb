...
Public Class viewTRASBOD

    Private Sub viewTRASBOD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cargarGrid()
        ...
        If FlyoutDialog.Show(Me.ParentForm, New viewFechaCAL) = DialogResult.OK Then
            ...
            Me.gridENTRADAS.DataSource = objvpn.getTblTRASVPN(GlobalParamDatePickI, GlobalParamDatePickF)
    ...
    Private Sub btnExportarDataProductos_Click(sender As Object, e As EventArgs) Handles btnExportarDataProductos.Click
        ...
        Try
            Dim archivo As String = Application.StartupPath + "/EXPORTS/TRASBOD" + Today.Month.ToString + ".xlsx"
