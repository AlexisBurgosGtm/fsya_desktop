...
Public Class viewInterfaceVentas

    Private Sub viewInterfaceVentas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnOnlineGetProductos_Click(sender As Object, e As EventArgs)
        Call NAVEGAR("SYNCPRODUCTOS")
    End Sub

    Private Sub btnOnlineVentasDomicilio_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnSubirVentasConta_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnOnlineDocsConta_Click(sender As Object, e As EventArgs)
    ...
    Private Sub TileNavPaneMain_ElementClick_1(sender As Object, e As DevExpress.XtraBars.Navigation.NavElementEventArgs)
        Dim tag As String = ""
        Try
            tag = e.Element.Tag.ToString
        Catch ex As Exception
    ...
    Private Sub btnSubirVentasConta_Click_1(sender As Object, e As EventArgs) Handles btnSubirVentasConta.Click
    ...
    'Private Sub TileItemActInv_ItemClick(sender As Object, e As DevExpress.XtraEditors.TileItemEventArgs) Handles TileItemActInv.ItemClick
    'If Confirmacion("Está seguro que desea Actualizar el Inventario, puede tardar unos minutos?", Me.ParentForm) = True Then
    'Dim objInventarios As New classInventario(GlobalEmpNit, GlobalAnioProceso, GlobalMesProceso)
    'SplashScreenManager.ShowForm(Me.ParentForm, GeneralWaitForm.GetType, True, True, ParentFormState.Locked)
    'Dim result As String
    ...
    Private Sub TileItemBONOS_ItemClick(sender As Object, e As DevExpress.XtraEditors.TileItemEventArgs) Handles TileItemBONOS.ItemClick
        ...
        If FlyoutDialog.Show(Me.ParentForm, New viewBONOSDEP) = DialogResult.OK Then

        End If

    End Sub

    Private Sub TileItemVENTAS_ItemClick(sender As Object, e As DevExpress.XtraEditors.TileItemEventArgs) Handles TileItemVENTAS.ItemClick
